  ...
  >
    ...
    <div class="flex flex-col md:flex-row justify-center gap-2 w-full">
      <div class="w-full md:w-2/4 flex flex-col gap-2">
        ...
        <ul>
          <li class="text-center py-2 mb-2 rounded-lg border-2 border-amber-300 hover:border-amber-400 shadow-lg hover:shadow-blue-500/50 transition duration-250 ease-out hover:ease-in" v-for="event in createdByMe" :key="event.id">
            <router-link
      ...
      <div class="w-full md:w-2/4 flex flex-col gap-2">
        ...
        <ul>
          <li class="text-center py-2 mb-2 rounded-lg border-2 border-amber-300 hover:border-amber-400 shadow-lg hover:shadow-blue-500/50 transition duration-250 ease-out hover:ease-in" v-for="event in invitedTo" :key="event.id">
            <router-link
              :to="{ name: 'event', params: { id: event.id } }"
              active-class="bg-cpurple text-cwhite"
              class="text-cblack hover:text-[#9a69fe] rounded-md px-3 py-2 text-sm font-medium"
